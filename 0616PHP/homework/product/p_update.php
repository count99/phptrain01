...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE product SET a_title=%s, a_story=%s, a_price=%s, a_pic=%s, a_firm=%s, a_time=%s, a_builder=%s WHERE a_seq=%s",
...
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
  <table width="1188" border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td align="center" valign="middle"><input name="a_firm" type="text" id="a_firm" value="<?php echo $row_Recordset1['a_firm']; ?>" /></td>
...
<tr>
      ...
      <td align="center" valign="middle">&nbsp;</td>
      <td align="center" valign="middle">&nbsp;</td>
      <td align="center" valign="middle"><img src="../images/<?php echo $row_Recordset1['a_pic']; ?>"/></td>
      <td align="center" valign="middle">&nbsp;</td>
      <td align="center" valign="middle">&nbsp;</td>
    </tr>
  </table>
