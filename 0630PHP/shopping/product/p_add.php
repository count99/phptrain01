...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO product (a_title, a_story, a_price, a_pic, a_firm, a_time, a_ip, a_builder, a_pn) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <table width="1429" border="1" cellpadding="0" cellspacing="0">
    <tr>
      <td width="196" align="center" valign="middle">商品名</td>
      <td width="343" align="center" valign="middle">商品敘述</td>
      <td width="191" align="center" valign="middle">產品編號</td>
    ...
    <tr>
      ...
      <input type="text" name="a_pn" id="a_pn" /></td>
      ...
      <td align="center" valign="middle"><label for="a_firm"></label>
        <label for="a_firm"></label>
        <select name="a_firm" id="a_firm">
<?php do{ ;?>
          <option value="<?php echo $row_Recordset1['f_seq'];?>"><?php echo $row_Recordset1['f_name'];?></option>
